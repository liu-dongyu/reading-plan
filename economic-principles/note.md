...
* 计算曲线中两个点的需求价格弹性，使用中心点法更准确
  * 例如 a 点：价格 = 4 数量 = 120；b 点：价格 = 6 数量 = 80
  * 中点：价格 = 5 数量 = 100；
  * 需求弹性价格 = |((120 - 80) / 100) / ((4 - 6) / 5)| = 1

#### 需求曲线的变化

* 当弹性 > 1，需求变动的百分比 > 价格变动百分比，需求是富有弹性的
* 当弹性 < 1，需求变动的百分比 < 价格变动百分比，需求的缺乏弹性的
* 当弹性 = 1，需求变动的百分比 = 价格变动百分比，需求是单位弹性
* 当需求曲线为竖直线，表示需求毫无弹性，价格的变动极小影响需求
* 当需求曲线为横直线，表示需求价格弹性无限大，价格的极小变动都会引起需求的极大变动
* 拇指规则：通过某一点的需求曲线约平坦，需求价格弹性约大，反之则越小
...
* 需求收入弹性是一种物品需求量对消费者收入变动反应程度的衡量
* 需求收入弹性 = 需求量变动百分比 / 收入变动百分比

#### 供给价格弹性

* 供给价格弹性衡量供给量对价格变动的反应程度
* 供给价格弹性关键取决于时间的长短，因为短时间内，企业不太可能轻易的改变生产规模等来减少或增加一种物品的供给量
* 供给价格弹性 = 供给量变动百分比 / 价格变动百分比

  * 例如冰淇淋从 3 上升到 3.3 快，生产商每月生产的生产的冰淇淋从 1 万上升到 1.15 万
  * 供给价格弹性 = ((1.15 - 1) / 1) / ((3.3 - 3) / 3) = 1.5

#### 供给曲线的变化

* 当供给曲线为竖直线，表示毫无弹性，价格变动极小影响供给
* 当供给曲线为横直线，表示供给价格弹性无限大，价格的极小变动都会引起供给量的极大变动
* 当弹性 > 1，供给变动的百分比 > 价格变动的百分比，供给是富有弹性的，曲线上对应点的切线与 y 轴相交
* 当弹性 < 1，供给变动的百分比 < 价格变动的百分比，供给是缺乏弹性的，曲线上对应点的切线于 x 轴相交
* 当弹性 = 1，供给变动的百分比 = 价格变动的百分比，称为单位弹性，曲线上对应点的切线和原点相交

<img src="./img/8.jpeg" width="350"  />

* 如上图所以，供给价格弹性并非一直不变。在很多市场上，企业往往存在最大生产能力，在供给量很低的时候，生产力没有得到发挥（可能由于存在限制的机器等原因导致），供给量对价格的反应十分敏感。一旦供给量持续上升，接近或达到企业的最大生产能力时，企业还想加大供给，可能就需要请更多的工人或者购买更多的工厂等，企业要承受住这种额外的支出，价格必然会大幅度上升，因此，供给变得缺乏弹性

#### 供给、需求与弹性的实际应用

##### 农业的好消息能是农民的坏消息吗？例如当农业科学家培育出更高产的杂交小麦时，种小麦的农民会有怎样的变动？

1. 种植新型的杂交小麦时，每亩产量更高，所以影响了供给曲线。小麦产量更高，农民自然愿意以某种既定价格出售更多的小麦，所以供给曲线向右边移动。供给曲线向右移动导致均衡价格下降，均衡数量上升，也就是小麦的价格会下降，供给量会提升
2. 总收益取决需求价格弹性，像小麦这种替代品少的物品一般缺乏弹性，供给量的增长并不能引起价格的很大变化，总收益有可能不升反而降低，所以种植新型的杂交小麦不一定使得农民的生活更美好
3. 由于每个农民对整个小麦市场的影响都是微小的，所以基于既定的市场价，个别农民的供给量上升，会使得其总收益上升。但如果所有种植小麦的农民都这样做，情况会变坏
4. 食物供给量上升与食物需求缺乏弹性相结合就引起了农业收益减少，这一点又鼓励了人们离开农业
5. 某些公共政策致力于减少某种作物的生产，就是为了降低供给量，提高农业的收益。但政策的代价则是损害消费者的利益，所以对农民有利不一定对整个社会有利

##### 一场摧毁了一半农作物的干旱会对农民是一件好事吗?如果这场干旱对农民是好事，为什么农民不会在没有干旱时摧毁自己的农作物?

1. 干旱影响了农作物的供给曲线，农民能提供的农作物减少，供给曲线往左边移动，均衡价格上升，均衡数量下降，换言之，农作物的供给量下降，价格上升
2. 农作物一般缺乏需求弹性，价格的变动不会引起需求量的很大变动，所以短期来说，干旱对于农民是好事，但长期来说，有可能导致农作物的需求弹性增长，对于农民是坏事
3. 由于个别农民对整个农作物市场的影响是微弱的，除非所有农民都摧毁自己的农作物，否则在既定的市场价格下，个别农民供给量下降势必导致总收益减少，得不偿失
